            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('favorite') }}">{{ __('Избранные товары') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('popularCategories') }}">{{ __('Популярные категории') }}</a>
                            </li>
                            ...
                            <li>
                                <div class="section serch">
                                    <form class="navbar-form navbar-right" role="search" action="{{ route('search') }}">
                                        <div class="form-group">
                                            <input name="text" type="text" class="form-control" placeholder="Найти">
                                        </div>
                                    </form>
                                </div>
                            </li>
